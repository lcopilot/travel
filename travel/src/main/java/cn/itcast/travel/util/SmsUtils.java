...
public class SmsUtils {
	...
	static final String accessKeyId = "LTAIGd25INPva14a";
	static final String accessKeySecret = "q8Q8XEDLz2NPM1rXbQvIi6ERXN9fvf";


	public static boolean sendRegistSms(String phone, String code) throws ClientException {
		return sendSms(phone, code, "SMS_170156451");
	}
	public static boolean sendLoginSms(String phone, String code) throws ClientException {
		return sendSms(phone, code, "SMS_170156454");
	}
	...
	public static void main(String[] args) throws ClientException {
		sendLoginSms("15367885410", "123456");
	}
}
