            ...
            <dl class="content">
                ...
                <dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" id="submit" type="submit"
        ...
        <div id="body2" class="tab-content" name="divcontent">
            <dl class="content">
                ...
                <dd id="btn-dd">
                        ...
                        class="note-help">商户订单号与支付宝交易号二选一，如果您点击“交易查询”按钮，即表示您同意该次的执行操作。</span>
                </dd>
            </dl>
        </div>
    </form>
        ...
        <div id="body3" class="tab-content" name="divcontent">
            <dl class="content">
                ...
                <dd id="btn-dd">
                        ...
                        class="note-help">商户订单号与支付宝交易号二选一，如果您点击“退款”按钮，即表示您同意该次的执行操作。</span>
                </dd>
            </dl>
        </div>
    </form>
        ...
        <div id="body4" class="tab-content" name="divcontent">
            <dl class="content">
                ...
                <dd id="btn-dd">
                        ...
                        class="note-help">商户订单号与支付宝交易号二选一，如果您点击“退款查询”按钮，即表示您同意该次的执行操作。</span>
                </dd>
            </dl>
        </div>
    </form>
        ...
        <div id="body5" class="tab-content" name="divcontent">
            <dl class="content">
                ...
                <dd id="btn-dd">
                        ...
                        class="note-help">商户订单号与支付宝交易号二选一，如果您点击“交易关闭”按钮，即表示您同意该次的执行操作。</span>
                </dd>
            </dl>
        </div>
    </form>--%>
...
<script language="javascript">
  ...
  function GetDateNow() {
    ...
    document.getElementById("WIDsubject").value = "${route.rname}";
    $("#WIDtotal_amount").val("${route.price}");
    $("#WIDbody").val("${route.routeIntroduce}");
  }
  ...
  $(function () {
    $("#submit").click(function () {
      $.post("cashierDesk/createOrder", {sNow: sNow}, function () {
